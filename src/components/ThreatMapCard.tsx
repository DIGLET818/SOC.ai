...
export function ThreatMapCard() {
    return (
        <Card className="border-border">
            ...
            <CardContent>
                <div className="relative bg-muted/30 rounded-lg p-6 h-[300px]">
                    {/* Faded globe background */}
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-muted-foreground">
                                                {source.attacks} attempts
                                            </p>
                                        </div>
                                    </div>
                                    <div
                                        className={`px-3 py-1 rounded-full text-xs font-medium ${source.severity === "high"
